...
@Entity
@Table(name = "ticket_mentions", indexes = {
        @Index(name = "idx_ticket_mentions_user", columnList = "mentioned_user_id")
}, uniqueConstraints = {
        @UniqueConstraint(name = "uk_ticket_mentions_ticket_user_message",
                columnNames = {"ticket_id", "mentioned_user_id", "message_id"})
})
